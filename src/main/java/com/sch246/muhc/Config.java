...
/**
 * 单一来源定义：动态生成 ModConfigSpec 与 Cloth Config 元数据。
...
public class Config {
    ...
    public static final class Entry<T> {
        ...
        private void attachSpec(ModConfigSpec.Builder b) {
            switch (type) {
                case INT -> {
                    NumericRange<Integer> r = (NumericRange<Integer>) range;
                    ModConfigSpec.IntValue v = b.comment(tooltipKey)
                ...
                case BOOLEAN -> {
                    ...
                    ModConfigSpec.BooleanValue v = b.comment(tooltipKey)
                            .translation(labelKey)
                            .define(key, def);
                    this.valueHandle = v;
                }
                case DOUBLE -> {
                    ...
                    ModConfigSpec.DoubleValue v = b.comment(tooltipKey)
                            .translation(labelKey)
                            .defineInRange(key, (Double) defaultValue, r.min, r.max);
                    this.valueHandle = v;
                }
                case STRING_LIST -> {
                    ModConfigSpec.ConfigValue<List<String>> v = b.comment(tooltipKey)
                            .translation(labelKey)
    ...
    public static ModConfigSpec.IntValue PRIORITY;
    public static ModConfigSpec.IntValue CENTER_SEARCH_RADIUS;
    public static ModConfigSpec.IntValue MAID_SEARCH_RADIUS;
    public static ModConfigSpec.IntValue REACH_RADIUS;
    public static ModConfigSpec.BooleanValue CLAIMS_BEFOREHAND;
    public static ModConfigSpec.BooleanValue RANDOM_WALK;
    public static ModConfigSpec.BooleanValue ITEM_FRAME_INTERACTION;
    public static ModConfigSpec.IntValue BUBBLE_INTERVAL;
    public static ModConfigSpec.IntValue OPERATION_INTERVAL;
    public static ModConfigSpec.IntValue OPERATION_DURATION;
    public static ModConfigSpec.IntValue BASE_STRESS;
    public static ModConfigSpec.IntValue STRESS_PER_FAVORABILITY;
    public static ModConfigSpec.BooleanValue ENDURANCE_OPERATION;
    public static ModConfigSpec.BooleanValue TWO_HANDED_OPERATION;
    ...
    static {
        ...
        PRIORITY = (ModConfigSpec.IntValue) find("basic", "priority");

        CENTER_SEARCH_RADIUS = (ModConfigSpec.IntValue) find("behavior", "centerSearchRadius");
        MAID_SEARCH_RADIUS = (ModConfigSpec.IntValue) find("behavior", "maidSearchRadius");
        REACH_RADIUS = (ModConfigSpec.IntValue) find("behavior", "reachRadius");
        CLAIMS_BEFOREHAND = (ModConfigSpec.BooleanValue) find("behavior", "claimsBeforehand");
        RANDOM_WALK = (ModConfigSpec.BooleanValue) find("behavior", "randomWalk");
        ITEM_FRAME_INTERACTION = (ModConfigSpec.BooleanValue) find("behavior", "itemFrameInteraction");

        BUBBLE_INTERVAL = (ModConfigSpec.IntValue) find("work", "bubbleInterval");
        OPERATION_INTERVAL = (ModConfigSpec.IntValue) find("work", "operationInterval");
        OPERATION_DURATION = (ModConfigSpec.IntValue) find("work", "operationDuration");
        BASE_STRESS = (ModConfigSpec.IntValue) find("work", "baseStress");
        STRESS_PER_FAVORABILITY = (ModConfigSpec.IntValue) find("work", "stressPerFavorability");
        ENDURANCE_OPERATION = (ModConfigSpec.BooleanValue) find("work", "enduranceOperation");
        TWO_HANDED_OPERATION = (ModConfigSpec.BooleanValue) find("work", "twoHandedOperation");
    }
